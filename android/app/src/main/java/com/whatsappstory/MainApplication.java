...
import com.whatsappstory.newarchitecture.MainApplicationReactNativeHost;
  ...
  private static void initializeFlipper(
    ...
    if (BuildConfig.DEBUG) {
      ...
      We use reflection here to pick up the class that initializes Flipper,
        ...
        */
        Class<?> aClass = Class.forName("com.whatsappstory.ReactNativeFlipper");
        aClass
          .getMethod(
            "initializeFlipper",
            Context.class,
